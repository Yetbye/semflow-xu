...
@torch.no_grad()
def pipeline_rf(timesteps,unet,z0,guidance_scale,rgb_images,y_labels,encoder_hidden_states=None):
    ...
    for i, t in enumerate(timesteps):
        ...
        v_pred ,cls_pred= unet(latent_model_input, t, encoder_hidden_states, y_labels, return_dict=False)
        t=t.expand(bsz)
        latents = latents + dt * v_pred 
        all_latents.append(latents)
        all_cls_preds.append(cls_pred)
    return latents, all_latents, all_cls_preds
