...
# )
    ...
    checkpoint = load_file("/home/ldp/LXW/SemFlow-xu/delta-FM/TransSegFlow/old_weight/checkpoint-60000/model.safetensors", device="cpu")
    ...
    for i, batch in enumerate(progress_bar):
        ...
        pred_latents, _ ,all_cls_preds= pipeline_rf(timesteps, unet, image_latents,guidance_scale, images,y_labels,encoder_hidden_states)
        ###################多标签分类预测####################
