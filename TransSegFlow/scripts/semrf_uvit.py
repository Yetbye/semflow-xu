...
from module.pipe.trans10k_val import trans10k_valrf
...
def main(args):
    ...
    checkpoint_path = "work_dirs/semflow_uvit/checkpoint-50000/model.safetensors"
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                model_pred,cls_pred = unet(perturb_latent, timesteps, y=dummy_y)
                target = latents - z0
                ###################损失函数################
