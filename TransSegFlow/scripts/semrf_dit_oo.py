...
from module.pipe.valrf_dit_o import valrf_dit_o
...
def main(args):
    ...
    checkpoint_path = "old_weight/semflow_dit_cls/checkpoint-45000/model.safetensors"
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                model_pred = unet(perturb_latent, timesteps, y_labels)
                target = latents - z0
