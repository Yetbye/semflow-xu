...
if __name__ == "__main__":
    ...
    parser.add_argument('--valmode',type=str,default='seg',choices=['seg','gen'])
    parser.add_argument('--valstep',type=int,default=25)
    parser.add_argument('--device',type=str,default='cuda')
    parser.add_argument('--ckpt',type=str,default='work_dirs/semflow/checkpoint-20000/checkpoint-10000')
    parser.add_argument('--sv_dir',type=str,default='work_dirs/semflow/checkpoint-20000/vis_test')
    parser.add_argument('--im_path',type=str,default='dataset/trans12cls/Trans10K_cls12/real/images/2927.jpg')
    parser.add_argument('--mask_path',type=str,default='dataset/trans12cls/Trans10K_cls12/real/masks_12/2927_mask.png')
